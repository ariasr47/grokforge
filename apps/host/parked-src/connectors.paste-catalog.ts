/**
 * PARKED 2026-09-13 — paste-workflow connector catalog (brother dogfood).
 * Why: Settings invented Gmail/Notion cards. Grok connectors live on grok.com.
 * Restore: apps/host/parked-src/PARKED.md
 * Do not import from host src.
 */
/**
