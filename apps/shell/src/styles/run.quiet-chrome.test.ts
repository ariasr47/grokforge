...
const css = readFileSync(path.join(root, "run.css"), "utf8");
const chrome = readFileSync(path.join(root, "chrome.css"), "utf8");
const dock = readFileSync(path.join(root, "dock.css"), "utf8");
const settings = readFileSync(path.join(root, "settings.css"), "utf8");
