...
import { EmptyStates } from "../surfaces/EmptyStates";
import { HomeScreen } from "../surfaces/HomeScreen";
import type { DesktopHostStatus, LaunchReason } from "../lib/api";
import { CARD_COPY } from "../projections/failureCard";
import { SETTINGS_UNSIGNED_LINE } from "../lib/installerHonesty";
import {
  createFakeHost,
  FakeWebSocket,
  installTauriGlobal,
