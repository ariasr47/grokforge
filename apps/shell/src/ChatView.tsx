...
import { api, type EffortLevel, type ProductMode, type PublicState } from "./api";
import type { FirstRunState } from "./firstRun";
import type { ChatSession } from "./sessions";
import type { InstallerShaVoucher } from "./installerHonesty";
import type { ChatMessage } from "./MessageList";
import type { RunProjection, RunProjectionRun, DecisionRequest } from "./runReducer";
import type { CatchUpMap } from "./catchUpWindows";
import type { ArtifactOpenBinding, ArtifactContentKind } from "./artifactOpenBinding";
import type { PermissionReq, PendingDiff } from "./runChangeList";
import type { ChangesDockFilesState } from "./ChangesDock";
import type {
  HomeChatHome,
  HomeFooterFacts,
  HomeNeedsYouItem,
...
import type { SkillsPaletteProjection } from "./skillsCatalogComposer";
import type { ChatPackComposerProjection } from "./chatPackComposer";
...
import { PLAN_LIVE_FOOTER } from "./planArm";
import { TranscriptBody } from "./TranscriptBody";
import { ArtifactPanel } from "./ArtifactPanel";
import { ActionDock } from "./ActionDock";
import { ComposerPane, composerBlockReasonVisible } from "./ComposerPane";
import { SETTLE_CARD_BELOW } from "./copyDock";
