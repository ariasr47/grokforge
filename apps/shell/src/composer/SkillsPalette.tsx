import { filterSkillCommands, SKILLS_CHECKING, SKILLS_EMPTY, SKILLS_FAILED, SKILLS_NO_MATCHES, SKILLS_RECONNECT, SKILLS_TITLE, type SkillsPaletteProjection } from "../projections/skillsCatalogComposer";
