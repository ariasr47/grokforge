...
import { isPackagedWindowsInstallerSession, SETTINGS_UNSIGNED_LINE } from "./installerHonesty";
import { channelBadge } from "./api";
import type { PaletteMode, PaletteSessionRow } from "./CommandPalette";
import type { WorkspaceNode } from "./Sidebar";
import {
  type HomeChatHome,
