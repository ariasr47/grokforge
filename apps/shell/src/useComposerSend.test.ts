...
import { initialRunProjection, type ActivityRecord, type RunProjection, type RunProjectionRun, type RunSnapshot } from "./runReducer";
...
function useHarness(props: HarnessProps) {
  ...
  const hook = useComposerSend({
    ...
    messagesRef: messagesRef as unknown as RefObject<import("./MessageList").ChatMessage[]>,
